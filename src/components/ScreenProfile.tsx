      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-200/60 pb-6 text-left">
          <div className="space-y-1">
            <h1 className="text-3xl sm:text-4xl font-serif font-bold text-[#1B362A] tracking-tight">
              Business Profile
            </h1>
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              className="px-5 py-2.5 rounded-full bg-[#1B362A] hover:bg-[#2A4C3C] text-white text-xs font-bold flex items-center gap-2 shadow-sm transition-all cursor-pointer"
            >
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="space-y-1">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <span className="bg-amber-100/80 text-amber-900 border border-amber-200/80 text-[10.5px] font-bold px-3 py-0.5 rounded-full flex items-center gap-1">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          {/* Widget 1 */}
          <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-2xs flex items-center gap-3.5 text-left">
            <div className="w-10 h-10 rounded-full bg-emerald-50 text-[#1B362A] flex items-center justify-center shrink-0 border border-emerald-100">
              <ChefHat className="w-5 h-5 text-[#1B362A]" />
            </div>
            <div>
          ...
          <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-2xs flex items-center gap-3.5 text-left">
            <div className="w-10 h-10 rounded-full bg-emerald-50 text-[#1B362A] flex items-center justify-center shrink-0 border border-emerald-100">
              <Users className="w-5 h-5 text-[#1B362A]" />
            </div>
            <div>
          ...
          <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-2xs flex items-center gap-3.5 text-left">
            <div className="w-10 h-10 rounded-full bg-emerald-50 text-[#1B362A] flex items-center justify-center shrink-0 border border-emerald-100">
              <Utensils className="w-5 h-5 text-[#1B362A]" />
            </div>
            <div>
          ...
          <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-2xs flex items-center gap-3.5 text-left">
            <div className="w-10 h-10 rounded-full bg-emerald-50 text-[#1B362A] flex items-center justify-center shrink-0 border border-emerald-100">
              <Building2 className="w-5 h-5 text-[#1B362A]" />
            </div>
            <div>
        ...
        {/* MAIN 2x2 SECTIONS GRID WITH FIELD DIVIDERS */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-7 border border-slate-200/80 shadow-2xs space-y-4 text-left">
            ...
            <div className="divide-y divide-slate-100 text-xs">
              <div className="py-2.5">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-0.5">NAME</span>
              ...
              <div className="py-2.5">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-0.5">ABOUT</span>
              ...
              <div className="py-2.5">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-0.5">ADDRESS</span>
                <span className="font-semibold text-slate-800">42, MG Road, Connaught Place, New Delhi, Delhi</span>
              </div>

              <div className="pt-2.5">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-0.5">WEBSITE</span>
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-7 border border-slate-200/80 shadow-2xs space-y-4 text-left">
            ...
            <div className="divide-y divide-slate-100 text-xs">
              <div className="py-2.5">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-0.5">OWNER</span>
              ...
              <div className="py-2.5">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-0.5">MANAGER</span>
              ...
              <div className="pt-2.5">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-0.5">BUSINESS EMAIL</span>
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-7 border border-slate-200/80 shadow-2xs space-y-4 text-left">
            ...
            <div className="divide-y divide-slate-100 text-xs">
              ...
              <div className="py-2.5">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-0.5">FSSAI</span>
                <span className="font-mono font-bold text-slate-900">13321001000123</span>
              </div>

              <div className="py-2.5">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-0.5">GST</span>
                <span className="font-mono font-bold text-slate-900">07AABCT1234H1ZS</span>
              </div>

              <div className="py-2.5">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-0.5">PAN</span>
                <span className="font-mono font-bold text-slate-900">AABCT1234H</span>
              </div>

              <div className="pt-3 flex flex-wrap items-center gap-2">
                <div className="bg-slate-100 px-3 py-1.5 rounded-full border border-slate-200/80 text-[11px] font-medium text-slate-700 flex items-center gap-1.5 cursor-pointer hover:bg-slate-200 transition-colors">
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-7 border border-slate-200/80 shadow-2xs space-y-4 text-left">
            ...
            <div className="divide-y divide-slate-100 text-xs">
              <div className="py-2.5">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-0.5">HEAD CHEF</span>
              ...
              <div className="py-2.5">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-0.5">CHEF EMAIL</span>
                <span className="font-semibold text-slate-800">chef@theroyalkitchen.in</span>
              </div>

              <div className="py-2.5 grid grid-cols-3 gap-2">
                <div>
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-0.5">CHEFS</span>
                  <span className="font-bold text-slate-900">8</span>
                </div>
                <div>
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-0.5">KITCHEN STAFF</span>
                  <span className="font-bold text-slate-900">45</span>
                </div>
                <div>
                  <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-0.5">SEATING CAPACITY</span>
                  <span className="font-bold text-slate-900">120</span>
                </div>
              </div>

              <div className="pt-2.5">
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest block mb-1.5">CUISINES</span>
