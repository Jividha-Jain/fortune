...
export default function AIPairingSuggestionsSection({ onNavigateTab }: AIPairingSuggestionsSectionProps) {
  ...
  return (
    <div className="w-full bg-[#FAF9FC] rounded-[36px] p-6 sm:p-8 lg:p-10 border border-slate-100 shadow-[0_4px_30px_rgba(0,0,0,0.02)] space-y-9 font-sans text-left relative overflow-hidden">
      ...
      {/* 1. TOP HERO SECTION */}
      <div className="relative flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 z-10 pt-2 min-h-[160px]">
        ...
        {/* Right Side: Cursive Handwriting Text + Bleeding Top-Right Plate */}
        <div className="hidden md:flex items-center gap-6 shrink-0 relative pr-0 lg:pr-24">
          
          {/* Cursive Handwriting Accent */}
          <div className="text-right font-serif italic text-lg sm:text-xl text-[#6B5A94] font-medium leading-[1.15] relative pr-2 rotate-[-3deg]">
